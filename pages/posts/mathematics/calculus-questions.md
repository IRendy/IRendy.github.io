...
3. $\lim_{x\rightarrow -\infty}x(\sqrt{x^2+100}+x)=$\_\_\_\_\_\_.
4. $\lim_{x\rightarrow 1}\frac{\sqrt{3-x}-\sqrt{1+x}}{x^2+x-2}=$\_\_\_\_\_\_.
5. $\lim_{x\rightarrow -\infty}\frac{\sqrt{4^2+x-1}+x+1}{\sqrt{x^2+\sin x}}$.
